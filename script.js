...
// Enter user searched city in DOM
...
async function displayWeather() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityname + "&units=imperial&appid=f841eb8a84a5331b78545ba0ade98b91";
    ...
    var response = await $.ajax({
        ...
        var uvURL = "https://api.openweathermap.org/data/2.5/uvi?appid=f841eb8a84a5331b78545ba0ade98b91&lat="+getLat+"&lon="+getLong;
        var uvResponse = await $.ajax({
            url: uvURL,
            method: "GET"
        })

        // Get UV index and assign color
...
async function displayFiveDayForecast() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q="+cityname+"&units=imperial&appid=f841eb8a84a5331b78545ba0ade98b91";
